          ...
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right" data-aos-duration="500" >
              <div className={styles.InnovativeBox}>
                ...
                <p>
                    Curo CBS is FinTechify’s flagship core
                    banking product it is web−enabled, multi
                    −currency, enterprise platform rich in
                    functionality covering the entire gamut of
                    banking operations ranging from basic
                    deposits, loans including micro finance and
                    advances to advanced treasury, remittances
                    and services.
                </p>
                <h5 className='mt-5'>Curo CBS at its core</h5>
                <ul className={styles.ulPoints}>
                  <li><MdOutlineKeyboardDoubleArrowRight />Core Configurations</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Front Desk Management</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Financial Management</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Loan Management</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Customer Care</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Document Management</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Bank Statements</li>
                </ul>
              </div>
