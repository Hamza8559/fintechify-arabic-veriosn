          ...
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right" data-aos-duration="500" >
              <div className={styles.InnovativeBox}>
                ...
                <p>
                  With Conexus – our Mobile Money Solution;
                  we enable service providers with complete
                  range of products to deliver extensive financial
                  services to the unbanked.
                </p>
                <h5 className='mt-5'>Conexus at its core</h5>
                <ul className={styles.ulPoints}>
                  <li><MdOutlineKeyboardDoubleArrowRight />Manages the entire mobile money eco-‐system</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Extensive products, features, limits and KYC configurations</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Supports closed-‐loop,semi-‐closed and open-‐loop models</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Allows the creation of distribution chain and commission hierarchies</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Integrated financial middleware allows integration with Financial Entities and External Application for service aggregation</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Analytics And Reports</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Transaction Channel (USSD, Mobile Web, Native Apps, Web and APIs)</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Prepaid CardsInventory and Distribution Management</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Integrated CRM, CMS, Workflow and Document Management</li>
                </ul>
              </div>
