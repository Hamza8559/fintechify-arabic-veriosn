          ...
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right" data-aos-duration="500" >
              <div className={styles.InnovativeBox}>
                ...
                <p>
                  Unlike most current video-oriented sites that only display a video AD at the beginning or the end of a video, the EVS Interactive Media Platform aims to place more contextually relevant interactive ADs at less intrusive positions within the video stream.
                </p>
                <h5 className='mt-5'>A POWERFUL CONTEXTUAL <br />AD SERVER FOR VIDEO CONTENT</h5>
                <ul className={styles.ulPoints}>
                  <li><MdOutlineKeyboardDoubleArrowRight />Media Management</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Video Context Editor</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />AD Manager</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Interactive Video Spot Designer</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />AD Campaign Manager</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Analytics And Reports</li>
                  <li><MdOutlineKeyboardDoubleArrowRight />Interactive Video Player</li>
                </ul>
