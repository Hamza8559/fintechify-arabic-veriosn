        ...
        <div className={`row`}>
          <div className={`col-lg-7 col-sm-12 ${style.rightBoxes}`} >
            <div className="row justify-content-end" id={`${style.flexRow}`}>
                <div className={`${style.card} col-md-5 col-sm-12`}>
                  ...
                  <span>
                    <Link href="/Banking-app-development" style={{ textDecoration: "none", color: "black" }}><LuArrowUpLeft className={style.arrow} /></Link>
                ...
                <div className={`${style.card} col-md-5 col-sm-12`}>
                  ...
                  <span>
                    <Link href="/Digital-wallet-development" style={{ textDecoration: "none", color: "black" }}><LuArrowUpLeft className={style.arrow} /></Link>
            ...
            <div className="row justify-content-end" id={`${style.flexRow}`}>
              <div className={`${style.card} col-md-5 col-sm-12`}>
                ...
                <span>
                  <Link href="/Insurance-software-development" style={{ textDecoration: "none", color: "black" }}><LuArrowUpLeft className={style.arrow} /></Link>
              ...
              <div className={`${style.card} col-md-5 col-sm-12`}>
                ...
                <span>
                  <Link href="/finops-services" style={{ textDecoration: "none", color: "black" }}><LuArrowUpLeft className={style.arrow} /></Link>
          ...
          <div className={`col-lg-5 ${style.check}`}>
            ...
            <button className={`${style.LuSend2}`}>
              <Link href="/service" style={{ textDecoration: "none", color: "white" }}><FiArrowUpLeft /> View All Services </Link>
            </button>
          </div>
        </div>
      </div>
