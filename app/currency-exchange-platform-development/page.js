                          ...
                          <div className='col-lg-6 p-lg-0'>
                            <div className={`${styles.processBox}  ${styles.blueBg} ${styles.currencyBlueUpperBox}`}>
                                ...
                                <ul>
                                    ...
                                    <p>We don’t do one-size-fits-all. We listen to your business goals and build a currency exchange platform that fits you perfectly. Need a quick converter? Done.  A trading powerhouse? We’ve got you covered.</p>
                                </ul>
                                <ul>
                                    <h5>Your Money, Our Priority</h5>
                                    <p>We understand finance is all about trust. That’s why our platforms are fortresses, built with top-notch encryption, two-factor authentication, and industry-leading compliance. Your users’ funds and data are safe and sound.</p>
                                </ul>
                            </div>
                        </div>
                        <div className='col-lg-6 p-lg-0'>
                            <div className={`${styles.processBox}  ${styles.whiteBg} ${styles.currencyWhiteBottomBox}`}>
                                <ul>
                                    ...
                                    <p>No more juggling systems! Our platforms integrate smoothly with all your financial partners, from APIs to banks and payment gateways. This means you can offer a wider range of currencies and payment options without the headache.</p>
                                </ul>
                                <ul>
                                    <h5>Grow Fearlessly</h5>
                                    <p>Don’t let your platform hold you back. We build with scalability in mind, so your currency exchange platform can expand as your business booms.  More users, more services, no problem. You’ll keep the same smooth performance you love.</p>
                                </ul>
                            </div>
                        </div>
                    </div>
