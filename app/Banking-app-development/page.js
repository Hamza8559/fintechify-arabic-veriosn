                            ...
                            <div className={styles.aboutFirstsection} data-aos="fade-right" data-aos-offset="300">
                                ...
                                <div className={styles.iconFlexBox}>
                                    ...
                                    <div>
                                        ...
                                        <span>Gain valuable customer data and spending habits to inform <br />future marketing strategies and product development.</span>
                                    </div>
                                </div>
                                <div className={styles.iconFlexBox}>
                                    <IoMdCheckmarkCircleOutline />
                ...
                <div className="container-fluid px-lg-5">
                    <div className="row">
                        <div className={styles.startedUpperBox}>
                            ...
                            <h4 className='text-center'>Get Started Today</h4>
                            <p className='text-center'>Tired of clunky banking apps? We build rocketships.</p>
                        </div>
                        <div className="col-lg-6">
